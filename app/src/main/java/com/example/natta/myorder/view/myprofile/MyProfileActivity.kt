...
class MyProfileActivity : AppCompatActivity(){
    ...
    private fun updateUI() {
        ...
        try {
            ...
            edt_postCode.setText(customer.address?.postalCode)
        } catch (e: Exception) {
        }
        Glide.with(this).load(customer.picture)
                .into(picture_myprofile)
        // Picasso.get().load(customer.picture).error(R.color.colorWhite).into(picture_myprofile)
    }
    ...
    private fun uploadToRTBD() {
        ...
        try {
            ...
            customerTemp.address?.postalCode = edt_postCode.text.toString()
        } catch (e: Exception) {
